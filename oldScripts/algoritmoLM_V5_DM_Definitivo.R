...
algoritmoLM <- function(tablaDatos){ 
 ...
 for(i in 1:NUM_COMPONENTES){ 
  ...
  cotaSuperior <- c(cotaSuperior,ESTIMADORES_INICIALES[i,1]+4,ESTIMADORES_INICIALES[i,2]+4,ESTIMADORES_INICIALES[i,3]+4,ESTIMADORES_INICIALES[i,4]+4,0.99,3/NUM_COMPONENTES)
